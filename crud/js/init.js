$(document).ready( function () {
    $('.login').validate({
        ...
        messages: {
            username: 'A user name is required',
    ...
    $('.users').DataTable({
        ...
        columns: [
            ...
            { data: 'id',
                fnCreatedCell: function (td, id) {
                    $(td).html('<div class="text-right"><a href="/updateUser?id='+id+'" title="Edit this user">Update</a> | <a href="/deleteUser?id='+id+'" class="text-danger" title="Delete this user" onClick="return confirm(\'Are you sure you want to delete this user?\');">Delete</a></div>');
                }
            }
        ],
        columnDefs: [ {
