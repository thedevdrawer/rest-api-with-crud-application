...
*         @OA\SecurityScheme(
*             type="http",
*             description="Use /auth to get JWT for token",
*             name="Authorization",
*             in="header",
*             scheme="bearer",
*             bearerFormat="JWT",
...
class Pages {
    ...
    */
    public function auth() {
        ...
        $exp = $iat + 60*60;
        $payload = array(
            "iss" => "http://livetest.local/api/", //issuer
    ...
    /**
    * @OA\Get(path="/api/v1/pages/read", tags={"Pages"},
    *   @OA\Response(response="200", description="Success"),
    *   @OA\Response(response="404", description="Not Found"),
    *   security={ {"bearerAuth": {}} },
    * )
    ...
    *               @OA\Property(property="content", type="string", example="<p>This is the about us page.</p>"),
